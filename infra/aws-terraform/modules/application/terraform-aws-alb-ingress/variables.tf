variable "namespace" {
  type        = "string"
  description = "Namespace, which could be your organization name, e.g. `or` or `orion`"
}
...
variable "http_listener_arn" {
  type        = "string"
  default     = ""
  description = "HTTP ALB listener ARN to attach ALB listener rule to"
}

variable "https_listener_arn" {
  type        = "string"
  default     = ""
  description = "HTTPS ALB listener ARN to attach ALB listener rule to"
}
