...
variable "aws_region" {
  type        = "string"
  default     = ""
  description = "AWS Region, e.g. us-west-2. Used as CodeBuild ENV variable when building Docker images. [For more info](http://docs.aws.amazon.com/codebuild/latest/userguide/sample-docker.html)"
}
